...
echo "GU assembly"
perl ../perl_scripts/gu_assembly_v4.1.pl d ./datasets/gu_library/Transcription_Factors.txt ./datasets/GUs_raw_files/ ./datasets/gu_library/
...
perl ../perl_scriptss/secondary_reaction_comparison.pl ./datasets/GUs_raw_files/ ./datasets/tmp1/ ./datasets/tmp2/ ./datasets/tmp_file.txt ./datasets/results/SRs_comparison.txt
